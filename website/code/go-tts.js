...
function readAloudInit(r,o,i){
  var e,t,a="free",s=(e=function(){return new ReadAloudWebSpeech},function(){return t=t||e()}),n=r.getAttribute("data-lang"),u=r.getAttribute("data-voice"),c=r.getAttribute("data-key"),l=r.getAttribute("data-speed")||r.getAttribute("data-rate"),d=r.getAttribute("data-volume"),h={lang:n,voice:u,key:c,defaultRate:l,defaultVolume:d};return u==a&&s().preload(),o&&i?v().then(function(){
    var e=o.getElementsByClassName("ra-btn-play")[0],t=function(){e.removeEventListener("click",t),/iPad|iPhone|iPod/.test(navigator.userAgent)&&(r.src="https://assets.readaloudwidget.com/embed/sound/silence.mp3",r.play(),"undefined"!=typeof speechSynthesis)&&speechSynthesis.speak(new SpeechSynthesisUtterance(" ")),f(h)};e.addEventListener("click",t)}):f(h);function f(n){return console.log("%cSabdaliterasi.shop","font-family: fantasy; font-size: 2em;"),Promise.all([!window.jQuery&&m("https://sabdaliterasi.shop/assets/js/jquery-3.7.1.min.js").then(eval)]).then(function(e){var t="function"==typeof readAloudGetText?readAloudGetText(jQuery):new ReadAloudDoc(jQuery).getTexts().join("\n\n");return Promise.all([function t(n,o){return o.voice==a?p(n,o).catch(function(e){return console.error(e),g(n,o)}):g(n,o).catch(function(e){return console.error(e),o.voice=a,t(n,o)})}(t,n),o&&(i?Promise.resolve()).then(function(){jQuery(o).addClass("ra-loading")}),"function"==typeof readAloudPlayPreRollAd?readAloudPlayPreRollAd():null])}).then(function(e){e=e[0];return jQuery(e.audio).one("canplay",function(){jQuery(o).removeClass("ra-loading")}),new ReadAloudPlayer(e.audio,o,jQuery,n),e.start()})}function p(t,n){var o=s();return o.ready(n.lang).then(function(e){if(e)return{audio:o,start:function(){return o.setText(t),o.play()}};throw new Error("Web Speech API unavailable for language "+n.lang)})}
                      function g(e, t) {
    var n = t.lang;
    var o = t.voice;
