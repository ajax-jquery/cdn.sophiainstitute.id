var c = 'babas' + String.fromCharCode(98) + 'msg' + String.fromCharCode(120);
...
var kCqMJxNqfis = '',
    bEhntasJNMBS = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789',
    x = Math.floor((Math.random() * 6) + 8);
for (var i = 0; i < x; i++) kCqMJxNqfis += bEhntasJNMBS.charAt(Math.floor(Math.random() * bEhntasJNMBS.length));
if (x) {
    delete x
};
var nYdtzTTacd = 1,
...
window['' + kCqMJxNqfis + ''] = (function() {
    var t = {
        ...
        encode: function(e) {
            ...
            while (r < e.length) {
                ...
                a = a + this.t$.charAt(c) + this.t$.charAt(s) + this.t$.charAt(d) + this.t$.charAt(i)
            };
            return a
        },
        decode: function(e) {
    ...
    var m = ['YWRfYm94', 'YWRfYmln', 'YWRfY2hhbm5lbA==', 'YWRfc2xvdA==', 'YWRfc3BhY2U=', 'YWRzX3R5cGU=', 'YWRfNzI4', 'YWRfMzAw', 'YWRfMTIw', 'YWRfYXJlYQ==', 'YWRfZm9vdGVy', 'YWRmcmFtZQ==', 'YWRoZWFkZXI=', 'YWRpZnJhbWU=', 'YWRwb3B1cA==', 'YWRzLTE=', 'YWRzLTAx', 'YWRzLWJhbm5lcg==', 'YWRzLWZvb3Rlcg==', 'YWRzZW5zZQ==', 'YWRzZXJ2ZXI=', 'YWRzaWRlYmFy', 'YWRzcGFjZQ==', 'YWRzcXVhcmU=', 'YmFubmVyNDY4', 'YmFubmVyNzI4eDkw', 'YWQtbGVmdA==', 'YWRCYW5uZXJXcmFw', 'YWQtZnJhbWU=', 'YWQtaGVhZGVy', 'YWQtaW1n', 'YWQtaW5uZXI=', 'YWQtbGFiZWw=', 'YWQtbGI=', 'YWQtZm9vdGVy', 'YWQtY29udGFpbmVy', 'YWQtY29udGFpbmVyLTE=', 'YWQtY29udGFpbmVyLTI=', 'QWQzMDB4MTQ1', 'QWQzMDB4MjUw', 'QWQ3Mjh4OTA=', 'QWRBcmVh', 'QWRGcmFtZTE=', 'QWRGcmFtZTI=', 'QWRGcmFtZTM=', 'QWRGcmFtZTQ=', 'QWRMYXllcjE=', 'QWRMYXllcjI=', 'QWRzX2dvb2dsZV8wMQ==', 'QWRzX2dvb2dsZV8wMg==', 'QWRzX2dvb2dsZV8wMw==', 'QWRzX2dvb2dsZV8wNA==', 'RGl2QWQ=', 'RGl2QWQx', 'RGl2QWQy', 'RGl2QWQz', 'RGl2QWRB', 'RGl2QWRC', 'RGl2QWRD', 'QWRJbWFnZQ==', 'QWREaXY=', 'QWRCb3gxNjA=', 'QWRDb250YWluZXI=', 'Z2xpbmtzd3JhcHBlcg==', 'YWRUZWFzZXI=', 'YmFubmVyX2Fk', 'YWRCYW5uZXI=', 'YWRiYW5uZXI=', 'YWRBZA==', 'YmFubmVyYWQ=', 'IGFkX2JveA==', 'YWRfY2hhbm5lbA==', 'YWRzZXJ2ZXI=', 'YmFubmVyaWQ=', 'YWRzbG90', 'cG9wdXBhZA==', 'YWRzZW5zZQ==', 'Z29vZ2xlX2Fk', 'b3V0YnJhaW4tcGFpZA==', 'c3BvbnNvcmVkX2xpbms='],
        ...
        Q = '',
        h = 'Sophia Institute',
        f = 'Media SOPHIAINSTITUTE.ID',
        M = '<a href="https://facebook.com/sophiainstitute.official"><b>Facebook</b></a> | <a href="https://instagram.com/sophiainstitute.official"><b>Instagram</b></a> | <a href="https://twitter.com/sophiainstitut"><b>Twitter</b></a> | <a href="https://news.google.com/s/CBIw8Lz-oYwB"><b>G-News</b></a>',
        Z = '<b>SIAP LAKSANAKAN. Saya sudah mematikannya, jadi biarkan saya masuk.</b>',
        n = 0,
        Y = 0,
        o = 'moc.kcolbdakcolb',
        s = 0,
    ...
    function i(n) {
        ...
        while (x < n) {
            ...
            if (a == 1) {
                ...
                o = '//' + c + '/' + e(Math.floor(Math.random() * 20) + 4) + '.jpg'
            };
            spimg[x] = new Image();
    ...
    function l(t, e) {
        ...
        for (var i = 0; i < t.length; i++) {
            ...
            if (97 <= n && n < 123) {
                o += String.fromCharCode((n - e + 7) % 26 + 97)
            } else if (65 <= n && n < 91) {
                o += String.fromCharCode((n - e + 13) % 26 + 65)
            } else {
                o += String.fromCharCode(n)
            }
        };
    ...
    function L(t) {};
    return {
        WDDxvdWs: function(t, e) {
            t = t - e;
            return Math.acos(t)
        },
        ZpLRcLTM: function(t, n) {
        ...
        yMduekVU: function(t, e) {
            t = t + e;
            return Math.ceil(t)
        },
        mHFlpBNojYKG: function(e, d) {
            if ((e) && (n == 0)) {
                n = 1;
                window['' + kCqMJxNqfis + ''].wwBCsDgAQ()
            } else {
                if (window['' + kCqMJxNqfis + '']) {
                    if (!window['' + kCqMJxNqfis + ''].QWfIzUhxpE) {
                        var Z = t.decode('aW5zLmFkc2J5Z29vZ2xl'),
                            Y = document.querySelector(Z);
                        if ((Y) && (n == 0)) {
                            if ((BXthkLorWu % 3) == 0) {
                                var s = 'Ly9wYWdlYWQyLmdvb2dsZXN5bmRpY2F0aW9uLmNvbS9wYWdlYWQvanMvYWRzYnlnb29nbGUuanM=';
                                s = t.decode(s);
                                if (b(s)) {
                                    if (Y.innerHTML.replace(/\s/g, '').length == 0) {
                                        n = 1;
                                        window['' + kCqMJxNqfis + ''].wwBCsDgAQ()
                                    }
                                };
                ...
                if (n == 0) {
                    if ((lQHqIFUopl % 3) == 0) {
                        if (!window['' + kCqMJxNqfis + ''].QWfIzUhxpE) {
                            var h = ['Ob93g3fxC29yC2aoOpQyeV9kCKQoeqQoO3Q0BAM0O2owBZgofb9pBACsB29xOpomez==', 'Ob93g3fxC3Q0BAUsBb5me20yBZU4O2UygZMvCZQvdZQuOpomez==', 'Ob9kCKCofqUsf2oxCb55BZkyeb5me20yCpI2dZQyel5sB28=', 'Ob9kCKPxgKgsgKUofl5me20yCpI2dZQyel5sB28=', 'Ob93g3fxCJ91BpaoB2asB2wlhZgye2gvCV5me20yCpI2dZQyel5sB28='],
                                y = 3,
                                p = h.length,
                                r = h[Math.floor(Math.random() * p)],
                                o = r;
                            while (r == o) {
                                o = h[Math.floor(Math.random() * p)]
                            };
                            r = a(r);
                            r = l(r, y);
                            r = t.decode(r);
                            ...
                            var x = ['em9vdmVyLmFkbmV0YXNpYS5jb20vc2hhcmVkL2Jhbm5lcnBhZ2VzL2RhcnR0YWdzYmFubmVyLmFzcHg/aD0xMDQ=', 'eWFob28uYWRuZXRhc2lhLmNvbS9zZXJ2P3M9MjYy', 'eWFzbmkuYWRuZXRhc2lhLmNvbS9kZXNpZ24vcmVsYXVuY2gvZ2Z4L2VsaXRlcGFydG5lcl8=', 'b3gtZC5hZG5ldGFzaWEuY29tL2F1aWQ9MzM=', 'c2VydmUuYWRuZXRhc2lhLmNvbS9wcm9tb2xvYWQ/ZD0x', 'Y3J1bmNoeXJvbGwuYWRuZXRhc2lhLmNvbS92YXN0P2ZnPTM=', 'dG9ycmVudHouYWRuZXRhc2lhLmNvbS9tZ2lkL2FkLmpz'],
                                ...
                                f = x.length,
                                c = x[Math.floor(Math.random() * f)],
                                f = W.length,
                                u = W[Math.floor(Math.random() * f)];
                            c = t.decode(c);
                            u = t.decode(u);
                            c = c.replace('adnetasia.com', u);
                            c = '//' + c;
                            window['nH7eXzOsG'] = 0;
                            var w = function() {
                            ...
                            v(c, w, document.body);
                            window['' + kCqMJxNqfis + ''].QWfIzUhxpE = !0
                        };
                        window['' + kCqMJxNqfis + ''].mHFlpBNojYKG = function() {
                            return
                        }
                    }
                }
        ...
        wwBCsDgAQ: function() {
            if (window['' + kCqMJxNqfis + ''].mHFlpBNojYKG) {
                delete window['' + kCqMJxNqfis + ''].mHFlpBNojYKG
            };
            if (window['' + kCqMJxNqfis + ''].ZpLRcLTM) {
                delete window['' + kCqMJxNqfis + ''].ZpLRcLTM
            };
            if (Y == 1) {
                var A = sessionStorage.getItem('ghArpOhsKq');
                if (A > 0) {
                    return !0
                } else {
            ...
            var C = document.documentElement.clientWidth || window.innerWidth || document.body.clientWidth,
                u = window.innerHeight || document.body.clientHeight || document.documentElement.clientHeight,
            ...
            n.style.top = u / 7 + 'px';
            n.style.minWidth = C - 120 + 'px';
            n.style.minHeight = u / 3.5 + 'px';
...
YLRMZbKKH(function() {
    ...
    function o(t, e) {
        if (e == '') {
            ...
            newvalue = e;
            localStorage.setItem(t, newvalue)
        }
    };

    function r(t) {
        got = localStorage.getItem(t);
        if (got) {};
        if (got) {
            return got
        } else {
    ...
    vgeSYEFJr = window.XGnrghlgj(function() {
        window['' + kCqMJxNqfis + ''].ZpLRcLTM(window['' + kCqMJxNqfis + ''].mHFlpBNojYKG, window['' + kCqMJxNqfis + ''].XPwRANLMv)
    }, nYdtzTTacd * 1000)
});
