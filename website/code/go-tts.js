...
function readAloudInit(r, o, i) {
    ...
    return u == a && s().preload(), o && i ? v().then(function() {
        var e = o.getElementsByClassName("ra-btn-play")[0],
            t = function() {
                e.removeEventListener("click", t), 
                f(h) // Pemutaran manual saat tombol diklik
            };
        e.addEventListener("click", t)
    }) : f(h);

    function f(n) {
        return console.log("%cSabdaliterasi.shop", "font-family: fantasy; font-size: 2em;"),
        Promise.all([!window.jQuery && m("https://sabdaliterasi.shop/assets/js/jquery-3.7.1.min.js").then(eval)])
            .then(function(e) {
                ...
                return Promise.all([
                    ...
                    o && (i ? Promise.resolve() : v()).then(function() {
                        jQuery(o).addClass("ra-loading")
                    }),
                    "function" == typeof readAloudPlayPreRollAd ? readAloudPlayPreRollAd() : null
                ])
            })
            .then(function(e) {
                e = e[0];
                ...
                // Pemutaran manual tanpa otomatis
                return new ReadAloudPlayer(e.audio, o, jQuery, n);
            })
    }
    ...
    function p(t, n) {
        ...
        return o.ready(n.lang).then(function(e) {
            if (e) return {
                audio: o,
                start: function() {
                    return o.setText(t); // Menghilangkan auto play
                }
            };
